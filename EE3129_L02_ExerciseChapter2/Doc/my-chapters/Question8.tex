...
$\Rightarrow$ \finalresult{V_{out} = R_{F}I_{in} \mp V_{os} \pm I_{-}R_{F} + V_{ref}}.
...
\begin{minipage}{.5\linewidth}
	\begin{itemize}[label=-]
		...
		\item Giá trị \finalresult{\Delta V _{max} =0.038800537\,\textsf{V}} và \finalresult{\Delta V _{min} = 0.000144875 \,\textsf{mV}}
		\item Sai số ở ngõ ra rơi vào tầm \finalresult{\Delta V_{o_{max}} = 0.78473\%} và \finalresult{\Delta V_{o_{min}} = 0.07438\%}
	\end{itemize}
\end{minipage}