...
$\Rightarrow$ \finalresult{V_{out} = \left( 1+ \dfrac{R_{2}}{R_{1}}\right) V_{in} \pm \left( 1+ \dfrac{R_{2}}{R_{1}}\right) V_{os} \pm I_{-}R_{2}}.
...
%	\includegraphics[width=.9\linewidth]{./my-chapters/my-images/Question6/I_os_I_ib_opa277u.pdf}
	\includegraphics[width=.9\linewidth]{./my-chapters/my-images/Question6/datasheet.png}
...
\begin{minipage}{.5\linewidth}
	\begin{itemize}[label=-]
		...
		\item Giá trị \finalresult{\Delta V _{max} = 0.029123677 = 29.123677\,\textsf{mV}} và \finalresult{\Delta V _{min} = 0.00934137 = 9.34137\,\textsf{mV}}
		\item Sai số ở ngõ ra rơi vào tầm \finalresult{\Delta V_{o_{max}} = 0.97730\%} và \finalresult{\Delta V_{o_{min}} = 0.93414\%}
	\end{itemize}
\end{minipage}