...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{./my-chapters/my-images/Cal_R_parallel/DC_sweep.png}
	\caption{Điện áp sau khi tuyến tính hóa.}
\end{figure}

Giá trị tính được thể hiện qua bảng excel sau:
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{./my-chapters/my-images/Cal_R_parallel/Linearity_R_eq.png}
\end{figure}