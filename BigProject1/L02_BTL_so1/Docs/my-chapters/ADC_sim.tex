...
\begin{itemize}[label=-]
	...
	\item \textbf{Cal\_Temp :} là giá trị chuyển đổi từ điện áp tính toán được \texttt{Cal\_V} về giá trị nhiệt độ theo công thức chuẩn là $T = \dfrac{V_{in} + \dfrac{5}{3}}{\dfrac{1}{12}}$.
\end{itemize}
