...
\begin{itemize}[label=-]
	...
	\[ \dfrac{V_{o1} - V_{io} - V_{o}}{R_{3}} + I_{L} = 0 \Rightarrow I_{L} = \dfrac{V_{io}}{R_{3}} \]
	
	\item Xét ảnh hưởng của $I_{io},\ I_{ib}$:
	\[ I_{+} - I_{-} = I_{io},\quad I_{+} + I_{-} = 2I_{ib} \Rightarrow I_{+} = 16nA,\ I_{-} = 20nA \]
	\[ \text{Khi } V_{i} = 0,\ V_{io} = 0\ \text{và } I_{+} \neq I_{-} \neq 0 \]
	Phương trình KCL tại nút (1):
	\[ I_{-} + \dfrac{0 - V_{o1}}{R_{1}} = 0 \Rightarrow V_{o1} = I_{-}R_{1} \]
	Phương trình KCL tại nút (2):
	\[ I_{+} + \dfrac{0 - V_{o}}{R_{2}} = 0 \Rightarrow V_{o} = I_{+}R_{2} \]
	Phương trình KCL tại nút (3):
	\[ I_{-} + \dfrac{V_{o1} - V_{o}}{R_{3}} + I_{L} = 0 \Rightarrow I_{L} = -I_{-}\left(1 + \dfrac{R_{1}}{R_{3}}\right) + I_{+}\dfrac{R_{2}}{R_{3}} \]
\end{itemize}
...
\begin{itemize}[label=-]
	...
	Ta có:\newline
	\[ V_{+} = V_{-} \]
	\[ \dfrac{V_{o1} - V_{-}}{R_{2}} = \dfrac{V_{-} - V_{1}}{R_{1}} \Longrightarrow V_{1} = \left(\dfrac{R_{1}}{R_{2}} + 1\right)V_{-} - \dfrac{R_{1}}{R_{2}}V_{o1} \]
	
	\item Opamp 2:\newline
	\[ \dfrac{V_{o2} - V_{+}}{R_{2}} = \dfrac{V_{+} - V_{2}}{R_{1}} \Longrightarrow V_{2} = \left(\dfrac{R_{1}}{R_{2}} + 1\right)V_{+} - \dfrac{R_{1}}{R_{2}}V_{o2} \]
	
	\item Ta có:\newline
	\[ \dfrac{V_{o1} - V_{o2}}{R_{x}} = \dfrac{V_{o2}}{Z_{L}} = I_{L} \Longrightarrow V_{o1} - V_{o2} = R_{x}I_{L} \]
	\[ V_{1} - V_{2} = -\dfrac{R_{1}}{R_{2}}\left(V_{o1} - V_{o2}\right) = -\dfrac{R_{1}}{R_{2}}R_{x}I_{L} \]
	\[ \Longrightarrow I_{L} = -\dfrac{R_{2}}{R_{1}R_{x}}\left(V_{1} - V_{2}\right) \]
\end{itemize}
...
\begin{itemize}[label=-]
	\item Xét ảnh hưởng của $V_{io}$:\newline
	\[ \text{Khi } V_{1} = V_{2} = 0,\ V_{io} \neq 0\ \text{và } I_{+} = I_{-} = 0 \]
	Phương trình KCL tại nút (1):
	\[ \dfrac{V_{io}}{R_{1}} + \dfrac{V_{io} - V_{o1}}{R_{2}} = 0 \Longrightarrow V_{o1} = \left(1 + \dfrac{R_{2}}{R_{1}}\right)V_{io} \]
	Phương trình KCL tại nút (2):
	\[ \dfrac{V_{io}}{R_{1}} + \dfrac{V_{io} - V_{o2}}{R_{2}} = 0 \Longrightarrow V_{o2} = \left(1 + \dfrac{R_{2}}{R_{1}}\right)V_{io} \]
	Phương trình KCL tại nút (3):
	\[ \dfrac{V_{io} - V_{o2} - V_{o1}}{R_{x}} + I_{L} = 0 \]
	\[ \Longrightarrow I_{L} = \dfrac{-V_{io} + \left(1 + \dfrac{R_{2}}{R_{1}}\right)V_{io} + \left(1 + \dfrac{R_{2}}{R_{1}}\right)V_{io}}{R_{x}} \]
	\[ \Longrightarrow I_{L} = \dfrac{\left(1 + \dfrac{2R_{2}}{R_{1}}\right)V_{io}}{R_{x}} = \dfrac{R_{1} + 2R_{2}}{R_{x}R_{1}}{\bullet V}_{io} \]
	
	\item Xét ảnh hưởng của $I_{io},\ I_{ib}$:\newline
	\[ I_{+} - I_{-} = I_{io},\quad I_{+} + I_{-} = 2I_{ib} \Rightarrow I_{+} = 16\ \text{nA},\ I_{-} = 20\ \text{nA} \]
	\[ \text{Khi } V_{1} = V_{2} = 0,\ V_{io} = 0\ \text{và } I_{+} \neq I_{-} \neq 0 \]
	Phương trình KCL tại nút (1):
	\[ I_{+} + \dfrac{0 - V_{o}}{R_{2}} = 0 \Longrightarrow V_{o} = I_{+}R_{2} \]
	Phương trình KCL tại nút (2):
	\[ I_{-} + \dfrac{0 - V_{o1}}{R_{1}} = 0 \Longrightarrow V_{o1} = I_{-}R_{1} \]
	Phương trình KCL tại nút (3):
	\[ I_{-} + \dfrac{V_{o1} - V_{o}}{R_{3}} + I_{L} = 0 \Longrightarrow I_{L} = -I_{-}\left(1 + \dfrac{R_{1}}{R_{3}}\right) + I_{+}\dfrac{R_{2}}{R_{3}} \]
\end{itemize}
