...
Ở đây dựa vào thiết kế của câu 7 ở trên, với tầm đo là $\Delta I_{in} = 10 - 1 = 9 \,\textsf{mA}$ và $\Delta V_{out} = 5 - 0 = 5\,\textsf{V}$
\[ \Rightarrow A_{v} = \dfrac{\Delta V_{out}}{\Delta I_{in}} = \dfrac{5}{9\,\textsf{m}} \approx 555.5556 \,\textsf{V/V}\]
$\Rightarrow Chọn R_{F} = 560\,\Omega$
...
\begin{minipage}{.5\linewidth}
	\begin{itemize}[label=-]
		...
		\item Giá trị \finalresult{\Delta V _{max} =0.038801\,\mu\textsf{V}} và \finalresult{\Delta V _{min} = -0.00074\,\mu\textsf{V}}
	\end{itemize}
\end{minipage}