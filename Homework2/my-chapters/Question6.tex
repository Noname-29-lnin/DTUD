...
\[ \Rightarrow V_{out} = 101V_{in} + \left[ 0.3005\,\textsf{mV}, 1.8845\,\textsf{mV}\right]\]
...
\begin{minipage}{.5\linewidth}
	\begin{itemize}[label=-]
		...
		\item Giá trị $\Delta V _{max} = 0.030654 = 30.654\,\textsf{mV}$ và $\Delta V _{min} = 0.010672 = 10.672\,\textsf{mV}$
	\end{itemize}
\end{minipage}