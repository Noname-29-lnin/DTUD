...
\begin{itemize}[label=-]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=.9\linewidth]{./my-chapters/my-images/Question1/Câu 1 a.png}
...
\begin{itemize}[label=-]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=.9\linewidth]{./my-chapters/my-images/Question1/Câu 1 b.png}
