...
$\Rightarrow$ \finalresult{V_{out} = R_{F}I_{in} - V_{os} + I_{-}R_{F}}.
...
\begin{minipage}{.5\linewidth}
	\begin{itemize}[label=-]
		...
		\item Giá trị \finalresult{\Delta V _{max} =28.0578\,\textsf{nV}} và \finalresult{\Delta V _{min} = -2.91189\,\mu\textsf{V}}
		\item Sai số ở ngõ ra rơi vào tầm \finalresult{\Delta V_{o_{max}} = 0.00003\%} và \finalresult{\Delta V_{o_{min}} = -0.00030\%}
	\end{itemize}
\end{minipage}